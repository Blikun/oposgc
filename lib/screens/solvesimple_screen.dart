...
/// PANTALLA DE CORRECCIONES DESPUES DE LOS TEST - ESTA MUESTRA LA CORRECCION DE MONO_TEST ///
...
class getsolvesimple extends StatelessWidget {
  String name;
  var random_array;
  var choicemade;

  getsolvesimple(this.name, this.random_array, this.choicemade);
  ...
  setasset2() {
    ...
    btnmap = {  /// marcado de casillas de respuesta ///
      for (var i = 0; i < 100; i++,)
        '$i': {
          "a": Colors.grey[800],
          "b": Colors.grey[800],
            ...
            body: Center(
              child: Text(
                "Cargando",
                      ...
                      return testpage2(mydata: mydata, random_array: random_array, choicemade: choicemade);
                    }
                );
              }
        }
...
class testpage2 extends StatefulWidget {
  ...
  testpage2({Key key, @required this.mydata,@required this.random_array, @required this.choicemade}) : super(key: key);

  @override
  _testpage2State createState() => _testpage2State(mydata, random_array, choicemade);
...
class _testpage2State extends State<testpage2> {
  ...
  _testpage2State(this.mydata, this.random_array, this.choicemade);
  ...
  Widget build(BuildContext context) {
    ...
    inicio();
    List<Widget> list = List.generate(count, (int index) => pagemake(mydata: mydata, index: index, random_array: random_array, choicemade: choicemade ));
...
class pagemake extends StatefulWidget {
  ...
  State<StatefulWidget> createState() =>
      _pagemake(mydata: mydata, index: index, random_array: random_array, choicemade: choicemade);
}
